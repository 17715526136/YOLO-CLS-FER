...
def get_params():
    params = {
        'weight': 'D:/gaijin/ultralytics-main/runs/classify/11-13/weights/best.pt',  # 现在只需要指定权重即可,不需要指定cfg
        'device': 'cuda:0',
        'method': 'HiResCAM',
...
if __name__ == '__main__':
    ...
    model(r'C:/Users/admin/Desktop/image/train_00001_aligned.jpg', 'result')
